                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                ...
                                                <span>Telefone: <?php echo $result->telefoneCliente?></span>
                                            </li>
                                        </ul>
                                    </td>
                                    <td style="width: 50%; padding-left: 0">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                if( $desconto->valorDesconto ) {
                                                    ?>
                                                    <h4 style="text-align: right">Valor: R$ <?php echo number_format($totalProdutos + $totalServico,2,',','.');?></h4>
                                                    <h4 style="text-align: right">Valor Desconto: R$ <?php echo number_format($desconto->valorDesconto,2,',','.');?></h4>
                                                    <h4 style="text-align: right">Valor Total: R$ <?php echo number_format($valorTotal->valorTotal,2,',','.');?></h4>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <h4 style="text-align: right">Valor: R$ <?php echo number_format($totalProdutos + $totalServico,2,',','.');?></h4>
