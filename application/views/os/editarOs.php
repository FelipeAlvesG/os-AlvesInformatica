                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <select class="span12" name="status" id="status" value="">
                                                ...
                                                <option <?php if($result->status == 'EncaminhadoTerceiros'){echo 'selected';} ?> value="EncaminhadoTerceiros" class="span-encaminhado">Encaminhado a Terceiros</option>
                                            </select>
                                        </div>
                                        <div class="span3">
...
<div class="modal-body">
    ...
    <div class="span12" style="margin-left: 0"> 
      ...
      <div class="span4" style="margin-left: 0">  
        ...
        <input class="span12 money" id="valorDesconto" type="text" name="valorDesconto" value="<?php echo number_format($total,2); ?> "  />
      </div>
      <div class="span4" >
    ...
    $(".money").maskMoney(); 
     ...
     $(document).on('click', '#btn-faturar', function(event) {
       event.preventDefault();
         ...
         valor_desconto = $("#valorDesconto").val();
         ...
         valorTotal = (valor + total_servico);
