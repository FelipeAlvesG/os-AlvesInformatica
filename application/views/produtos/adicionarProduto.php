        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        <label for="descricao" class="control-label">Código de barra<span class="required">*</span></label>
                        <div class="controls">
                            <input id="codigoProduto" type="text" name="codigoProduto" value="<?php echo set_value('codigoProduto'); ?>"  />
                        </div>
                    </div>
