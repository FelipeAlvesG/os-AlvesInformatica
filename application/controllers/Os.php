...
class Os extends CI_Controller {
    ...
    function editar() {
        ...
        $this->data['desconto'] = $this->os_model->getDescontoOs($this->uri->segment(3));
        $this->data['valorTotal'] = $this->os_model->getvalorTotalOs($this->uri->segment(3));
    ...
    public function faturar() {
        ...
        if ($this->form_validation->run('receita') == false) {
            ...
            if ($this->os_model->add('lancamentos',$data) == TRUE) { 
                ...
                $valorTotal = $this->input->post('valor') - $this->input->post('valorDesconto');

                $this->db->set('faturado',1);
                $this->db->set('valor',$this->input->post('valor'));
                $this->db->set('valorDesconto',$this->input->post('valorDesconto'));
