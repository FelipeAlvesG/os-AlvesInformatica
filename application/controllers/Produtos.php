...
class Produtos extends CI_Controller {
    ...
    function index(){
        ...
        if ( !empty($this->input->post('idProdutoBusca')) ) {

            $this->gerenciar($this->input->post('idProdutoBusca'),'');

        } elseif ( !empty($this->input->post('codigoProduto')) ) {

            $this->gerenciar('',$this->input->post('codigoProduto') );
    ...
    function gerenciar( $idProduto = null, $codigoProduto = null ){
        ...
        if( $idProduto ){
            $this->data['results'][0] = $this->produtos_model->getById($idProduto);
           
        } elseif ( $codigoProduto ) {

            $this->data['results'][0] = $this->produtos_model->getByCodigo($codigoProduto);

        } else {
            $this->data['results'] = $this->produtos_model->get('produtos','idProdutos,descricao,unidade,precoCompra,precoVenda,estoque,estoqueMinimo,codigoProduto','',$config['per_page'],$this->uri->segment(3));
        }
    ...
    function adicionar() {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            $data = array(
                ...
                'codigoProduto' => set_value('codigoProduto')
            );
